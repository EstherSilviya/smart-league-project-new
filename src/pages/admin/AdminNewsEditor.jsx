                 ...
                 <div className="p-6 flex-1 overflow-y-auto space-y-4">
                   <div className="flex items-center gap-3">
                     ...
                     <div>
                       ...
                       <p className="text-xs font-bold text-primary">{form.studentName || 'Student Name'}</p>
                       {form.courseYear && <p className="text-[10px] text-slate-500">{form.courseYear}</p>}
                     </div>
                   </div>
